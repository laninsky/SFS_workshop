...
For your own projects, it is worth writing out the cubsfs_results and boot.res objects in case you want to compare AIC values between different numbers of knots/oldest knot time values to optimize the choices around these. Next up, [plotting these prettily using ggplot2](../3_Plotting_with_tidyverse/README.Md).